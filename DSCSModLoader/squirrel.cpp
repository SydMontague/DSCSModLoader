...
using PTR_sq_wakeupvm = SQRESULT(*)(HSQUIRRELVM v, SQBool resumedret, SQBool retval, SQBool raiseerror, SQBool throwerror);
using PTR_sq_getvmstate = SQInteger(*)(HSQUIRRELVM v);

/*compiler*/
using PTR_sq_compile = SQRESULT(*)(HSQUIRRELVM v, SQLEXREADFUNC read, SQUserPointer p, const SQChar* sourcename, SQBool raiseerror);
using PTR_sq_compilebuffer = SQRESULT(*)(HSQUIRRELVM v, const SQChar* s, SQInteger size, const SQChar* sourcename, SQBool raiseerror);
...
using PTR_sq_getclosureinfo = SQRESULT(*)(HSQUIRRELVM v, SQInteger idx, SQUnsignedInteger* nparams, SQUnsignedInteger* nfreevars);
...
void sq_close(HSQUIRRELVM v) {
	return ((PTR_sq_close)((char*)GetModuleHandle(NULL) + OFF_sq_close))(v);
}
...
SQRESULT sq_wakeupvm(HSQUIRRELVM v, SQBool resumedret, SQBool retval, SQBool raiseerror, SQBool throwerror) {
	return ((PTR_sq_wakeupvm)((char*)GetModuleHandle(NULL) + OFF_sq_wakeupvm))(v, resumedret, retval, raiseerror, throwerror);
}
...
SQRESULT sq_compilebuffer(HSQUIRRELVM v, const SQChar* s, SQInteger size, const SQChar* sourcename, SQBool raiseerror) {
	return ((PTR_sq_compilebuffer)((char*)GetModuleHandle(NULL) + OFF_sq_compilebuffer))(v, s, size, sourcename, raiseerror);
}
...
void sq_poptop(HSQUIRRELVM v) {
	return ((PTR_sq_poptop)((char*)GetModuleHandle(NULL) + OFF_sq_poptop))(v);
}
void sq_remove(HSQUIRRELVM v, SQInteger idx) {
	return ((PTR_sq_remove)((char*)GetModuleHandle(NULL) + OFF_sq_remove))(v, idx);
}
SQInteger sq_gettop(HSQUIRRELVM v) {
	return ((PTR_sq_gettop)((char*)GetModuleHandle(NULL) + OFF_sq_gettop))(v);
}
...
SQInteger sq_cmp(HSQUIRRELVM v) {
	return ((PTR_sq_cmp)((char*)GetModuleHandle(NULL) + OFF_sq_cmp))(v);
}
...
void sq_newtable(HSQUIRRELVM v) {
	return ((PTR_sq_newtable)((char*)GetModuleHandle(NULL) + OFF_sq_newtable))(v);
}
...
void sq_pushnull(HSQUIRRELVM v) {
	return ((PTR_sq_pushnull)((char*)GetModuleHandle(NULL) + OFF_sq_pushnull))(v);
}
...
void sq_reseterror(HSQUIRRELVM v) {
	return ((PTR_sq_reseterror)((char*)GetModuleHandle(NULL) + OFF_sq_reseterror))(v);
}
